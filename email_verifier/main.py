...
async def verify_one_email(raw_email: str) -> EmailResult:
    ...
    if raw_email.endswith("@test.io"):
        ...
        valid_statuses = [
            "safe", "catch_all", "role_account", "spamtrap", "inbox_full",
        ...
        if status_to_force in valid_statuses:
            ...
            res = {
                ...
                "overall_score": 100 if status_to_force == "safe" else 0,
                "is_safe_to_send": status_to_force == "safe",
                "is_valid_syntax": status_to_force != "invalid",
                "is_disposable": status_to_force == "disposable",
                "is_role_account": status_to_force == "role_account",
                ...
                "is_deliverable": status_to_force == "safe",
                "is_disabled": status_to_force == "disabled",
                "is_spamtrap": status_to_force == "spamtrap",
                 "is_free_email": False,
                "is_gibberish": False,
                "gibberish_score": 0,
...
async def verify_bulk(
    ...
    summary_data = {
        ...
        "role_account": sum(1 for r in results if r.status == "role_account"),
        ...
        "spamtrap": sum(1 for r in results if r.status == "spamtrap"),
